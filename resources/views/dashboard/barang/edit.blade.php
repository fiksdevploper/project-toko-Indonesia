...
<body class="bg-hitam">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8 sm:ml-64">
            <h2 class="text-xl font-bold mb-4 text-putih">Edit Barang</h2>
            <form action="{{ route('barang.update', $barang->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        class="mt-1 p-2 w-full rounded-md bg-hitammuda text-putih pl-10" required>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        class="mt-1 p-2 w-full border border-gray-200 rounded-md bg-hitammuda text-putih pl-10" required>
                    </div>
                ...
                <div class="flex justify-end">
                    <button type="submit" class="px-4 py-2 bg-biru text-white rounded-md">
