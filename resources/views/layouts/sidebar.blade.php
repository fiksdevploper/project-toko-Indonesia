                ...
                <ul>
                    <li class="mb-4">
                        <a href="{{ route('chart.barang') }}"
                            class="flex items-center gap-2 p-2 rounded-lg transition-colors {{ request()->routeIs('chart.barang') ? 'bg-birumuda' : 'hover:bg-birumuda' }}">
                    ...
                    <li class="mb-4">
                        <a href="{{ route('barang') }}"
                            class="flex items-center p-2 rounded-lg transition-colors {{ request()->routeIs('barang') ? 'bg-birumuda' : 'hover:bg-birumuda' }}">
                    ...
                    <li class="mb-4">
                        <a href="{{ route('suppliers') }}"
                            class="flex items-center p-2 rounded-lg transition-colors {{ request()->routeIs('suppliers') ? 'bg-birumuda' : 'hover:bg-birumuda' }}">
                            <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                    ...
                    <li class="mb-4">
                        <a href="{{ route('todolist.admin') }}"
                            class="flex items-center p-2 rounded-lg transition-colors {{ request()->routeIs('todolist.admin') ? 'bg-birumuda' : 'hover:bg-birumuda' }}">
